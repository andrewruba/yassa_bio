...
def test_non_plate_items_raise(bad_item):
    with pytest.raises(ValidationError):
        DataMap(plates=[bad_item])


def test_nested_plate_validation_bubbles_up():
    bad_plate_dict = {
        "plate_id": "Bad",
        "wells": [
