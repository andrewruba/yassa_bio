...
from yassa_bio.evaluation.acceptance.engine.accuracy import eval_accuracy
...
class TestEvalAccuracy:
    ...
    def test_mixed_levels_edge_vs_mid(self):
        ...
        assert result["per_level"][QCLevel.LLOQ]["acc_tol"] == 25
        assert result["per_level"][QCLevel.MID]["acc_tol"] == 15
